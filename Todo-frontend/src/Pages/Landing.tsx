...
export const Landing = () =>{
  ...
  function addTodo() {
    ...
    <div className="bg-[#333333] min-h-screen">
        <Navbar1/>
      {/* Hero section */}
      <section className="container relative flex min-h-[60vh] flex-col items-center justify-center text-center">
        <h1 className="mx-auto max-w-3xl text-4xl font-semibold leading-tight tracking-tight md:text-5xl">
          <span className="text-foreground/70">Simple Lightweight </span>
          <span className="font-extrabold text-foreground">Todo App</span>
        </h1>
        <p className="mt-4 max-w-2xl text-lg leading-relaxed text-foreground/80">
          Offers simplicity while notes making
